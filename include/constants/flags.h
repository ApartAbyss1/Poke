...
#define KANTO                0x20 // Unused Flag
#define JOHTO                0x21 // Unused Flag
#define HOENN                0x22 // Unused Flag
#define SINNOH               0x23 // Unused Flag
#define UNOVA                0x24 // Unused Flag
#define KALOS                0x25 // Unused Flag
#define ALOLA                0x26 // Unused Flag
#define GALAR                0x27 // Unused Flag
#define PALDEA               0x28 // Unused Flag
#define FLAG_POKEMONPCMENU   0x21 // PC MENU
#define FLAG_PARTY_MOVES     0x2A // Party Moves
